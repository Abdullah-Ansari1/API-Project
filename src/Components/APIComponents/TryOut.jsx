            ...
            <div className="tryout-header">
                <div className="tryout-left-header">
                    ...
                    <div className="radio-div">
                        <span onClick={(e)=>setRadioCheck("OAuth")} className="radiodiv-span">
                            <input
                                name="OAuth"
                                type="radio"
                        ...
                        <span onClick={(e)=>setRadioCheck("APIKey")} className="radiodiv-span">
                            <input
                                name="APIKey"
                                type="radio"
                        ...
                        <span onClick={(e)=>setRadioCheck("Basic")} className="radiodiv-span">
                            <input
                                name="Basic"
                                type="radio"
